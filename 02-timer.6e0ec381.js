...
},{}],"../node_modules/flatpickr/dist/themes/dark.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
...
function isDatePickedInFuture(dates, dateStr) {
  var deltaTime = dates[0].getTime() - Date.now();
  if (deltaTime < 0) {
    _notiflixNotifyAio.Notify.warning('You picked the date in the past ' + dateStr);
  } else {
    refs.startBtn.disabled = false;
  }
}
function onStartTbnClick() {
  var deltaTime = selectedDate - Date.now();
...
function getTimerStarted(ms) {
  ...
  var timerId = setInterval(function () {
    if (timer - interval >= 0) {
      ...
      refs.timerEl.insertAdjacentHTML('beforeend', '<div class="timerStop">TIME IS UP!</div>');
...
function getInterface(_ref) {
  var days = _ref.days,
    hours = _ref.hours,
    minutes = _ref.minutes,
    seconds = _ref.seconds;
  return refs.daysEl.textContent = "".concat(addLeadingZero(days)), refs.hoursEl.textContent = "".concat(addLeadingZero(hours)), refs.minutesEl.textContent = "".concat(addLeadingZero(minutes)), refs.secondsEl.textContent = "".concat(addLeadingZero(seconds));
}
function addLeadingZero(value) {
  return String(value).padStart(2, '0');
}
},{"flatpickr":"../node_modules/flatpickr/dist/esm/index.js","flatpickr/dist/flatpickr.min.css":"../node_modules/flatpickr/dist/flatpickr.min.css","notiflix/build/notiflix-notify-aio":"../node_modules/notiflix/build/notiflix-notify-aio.js","flatpickr/dist/themes/dark.css":"../node_modules/flatpickr/dist/themes/dark.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
